    ...
    <section className="py-12 bg-primary text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative w-full h-[500px] rounded-lg shadow-lg overflow-hidden">
          ...
          <button
            onClick={goToPrev}
            className="absolute top-1/2 left-4 -translate-y-1/2 bg-accent bg-opacity-80 text-white p-2 rounded-full hover:bg-opacity-90 transition-colors"
          >
            &#10094;
          </button>
          <button
            onClick={goToNext}
            className="absolute top-1/2 right-4 -translate-y-1/2 bg-accent bg-opacity-80 text-white p-2 rounded-full hover:bg-opacity-90 transition-colors"
          >
            &#10095;
          </button>
        </div>
